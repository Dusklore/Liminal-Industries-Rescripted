...
execute if score RNG RNG_Variable matches 1..5 run function backrooms:railrooms/sector_1_rooms/exit_points/eastwest
execute if score RNG RNG_Variable matches 6..7 run function backrooms:railrooms/sector_1_rooms/exit_points/southwest
execute if score RNG RNG_Variable matches 8..9 run function backrooms:railrooms/sector_1_rooms/exit_points/northwest
execute if score RNG RNG_Variable matches 10..11 run function backrooms:railrooms/sector_1_rooms/exit_points/northsouthwest
execute if score RNG RNG_Variable matches 12..13 run function backrooms:railrooms/sector_1_rooms/exit_points/southeastwest

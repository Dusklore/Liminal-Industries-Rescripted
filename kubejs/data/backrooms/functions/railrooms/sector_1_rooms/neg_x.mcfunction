...
execute if score RNG RNG_Variable matches 6..7 run function backrooms:railrooms/sector_1_rooms/exit_points/southeast
execute if score RNG RNG_Variable matches 8..9 run function backrooms:railrooms/sector_1_rooms/exit_points/northeast

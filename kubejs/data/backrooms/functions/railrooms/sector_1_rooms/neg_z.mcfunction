...
execute if score RNG RNG_Variable matches 8..9 run function backrooms:railrooms/sector_1_rooms/exit_points/southwest
...
execute if score RNG RNG_Variable matches 14..15 run function backrooms:railrooms/sector_1_rooms/exit_points/southeastwest

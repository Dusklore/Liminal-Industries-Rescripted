	...
	event.create('sculked_sculk_scrubber').displayName('Sculked Sculk Scrubber')
		...
		.blockEntity(entityInfo => {
			entityInfo.serverTick(10, 0, entity => {
				...
				entity.level.getServer().runCommandSilent(`execute in ${dimension} positioned ${pos_x} ${pos_y} ${pos_z} run backrooms blocks tick scrubber`)
			})
		})
...
StartupEvents.registry('item', event => {
	...
	event.create('copycat_alloy').displayName('Copycat Alloy')
	...
	event.create('carpet_fluid').displayName('Carpet Fluid').unstackable()
	event.create('unstable_compound').displayName('Unstable Compound').unstackable()
})
